...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.DaemonSetRef":      schema_pkg_apis_kosmos_v1alpha1_DaemonSetRef(ref),
		"github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.DaemonSetRefList":  schema_pkg_apis_kosmos_v1alpha1_DaemonSetRefList(ref),
...
func schema_pkg_apis_kosmos_v1alpha1_DaemonSetRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"knode": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.Knode"),
						},
					},
					"refType": {
						SchemaProps: spec.SchemaProps{
				...
				Required: []string{"daemonSet", "knode", "refType"},
			},
		},
		Dependencies: []string{
			"github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.DaemonSet", "github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.Knode", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_kosmos_v1alpha1_DaemonSetRefList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			"github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.DaemonSet", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.TypeMeta"},
	}
}
...
func schema_pkg_apis_kosmos_v1alpha1_Knode(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.KnodeSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.KnodeStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.KnodeSpec", "github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.KnodeStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_kosmos_v1alpha1_KnodeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
		...
		Dependencies: []string{
			"github.com/kosmos.io/kosmos/pkg/apis/kosmos/v1alpha1.Knode", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_kosmos_v1alpha1_KnodeSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_kosmos_v1alpha1_KnodeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
